# Generated by Django 2.2.13 on 2021-01-23 22:15
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('month_executor_pay', models.DateField(help_text='місяць нарахування ЗП монтажнику', verbose_name='місяць/рік')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fuel_sensor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='fuel_sensor_project_works', to='products.FuelSensor', verbose_name='ДВРП')),
                ('gps', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gps_project_works', to='products.Gps', verbose_name='БР')),
                ('type_service', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='completed_project_works', to='products.Service', verbose_name='виконані роботи')),
                ('work_order_project', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='list_project_works', to='workorders.WorkOrder', verbose_name='ЗН')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_order_service', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='list_service_works', to='workorders.WorkOrder', verbose_name='ЗН')),
            ],
            options={
